# MySqlBackUp
BackUp Desktop and Send Email with zip Attached


 ### Step to install
 - pip install -r requirement
 - pip install google-api-python-client
 - cp config_copy.py to config.py and update with details(using Google Console)


 ### BackUp MySQL Database Daily
0 20 * * * /usr/bin/python /PYTHON/MySqlBackUp/backup.py
